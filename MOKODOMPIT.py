    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCBb99KwBlLCxqhgyEsmlWXw')
                time.sleep(2)
                menu()
