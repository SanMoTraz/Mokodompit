...
\033[1;91m ┈┈┈▕▕╲┊┊╱▏▏┈┈┈☞☞☞☞☞☞\033[0;37m☜☜☜☜☜┈┈┈▕▕╲┊┊╱▏▏┈┈┈
\033[1;91m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[0;37m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;91m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈☜☜☜☜☜☜\033[0;37m\033[0;37m☜☜☜☜☜┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;91m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[0;37m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;91m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[0;37m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;91m..............\033[1;96mSANMOTRAZ GAMING TUTORIAL\033[0;37m.............
\033[1;91m................\033[1;96m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[0;37m...............
\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
\033[1;91m☞ Author     : Wahyu Candra Pranata
\033[1;92m☞ Support    : Sandy Mokodompit
\033[1;95m☞ YouTube    : SanMoTraz Gaming
\033[1;93m☞ Whatsapp   : 081240175436
\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
                                '''
back=0
successfull=[]
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    st.close()
		    print (S + '[☆]' + Y + ' Login sukses 100% ✓')
		    os.system('xdg-open https://www.youtube.com/channel/UCn9x-lhJSeoyYHfSRdUVWmA')
		    menu()
		else:
		    if "www.facebook.com" in z["error_msg"]:
		        print (R + 'Akunmu kena Checkpoint !')
		        t()
		        login()
		    else:
		        print (R + 'email/user id/ Sandi salah !')
		        trb()
		        t()
		        login()
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Sanmotraz Gaming Tutorial Tools')
	print (S + '[' + P + '☞3' + S + ']' + S + ' SANMOTRAZ GAMING TUTORIAL')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Samotraz Gaming-Tutorial')
	    os.system('cd $HOME && git clone https://github.com/SanMoTraz/Mokodompit)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('☆☆☆☆☆☆☆☆☆90%')
	    psb('☆☆☆☆☆☆☆☆☆☆100%')
	    psb('Login Ke Akun Baru')
	    psb('facebook id Sandy Wales')
	    psb('WellCome To Sanmotraz Gaming Tutorial')
	    psb('Congratulations Sanmotraz Gaming Tutorial Tools Has Been Updated Successfully')
	    psb('🔓User Name☆ wahyu')
	    psb('🔓Password ☆ indonesia')
	    psb('Subscrbe Channel Yutube Ku Sanmotraz Gaming Tutorial')
	    psb('Silahkan Login Kembali')
	elif bm =='3':
	    os.system('xdg-open https://www.youtube.com/channel/UCn9x-lhJSeoyYHfSRdUVWmA')
	    menu()
	elif bm =='4':
...
def pb():
	...
	print(S+50*'-')
	print
	print(S+'Login Akun Yang Cp Dalam Waktu 7 Hari ')
	print(Y+'Total '+G+'OK'+S+'/'+P+'CP'+S+' = '+G+str(len(oks))+S+'/'+R+str(len(cps)))
	print(S+'Sandy Mokodompit')     
	print
	raw_input(R + 'Back')
	os.system('python2 Mokodompit')
